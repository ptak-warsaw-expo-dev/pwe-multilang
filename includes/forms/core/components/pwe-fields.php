...
final class PWE_Multilang_GF_Fields {
    ...
    public static function Text(
        ...
        $base = [
            ...
            'conditionalLogic' => $conditionalLogic,
            'allowsPrepopulate'     => $allowsPrepopulate,
            'inputName'             => $inputName,
        ];
    ...
    public static function Phone(
        ...
        // bool $smartPhoneFieldGField = true, // old validation, not used anymore
        $conditionalLogic = null,
    ): array {
        $base = [
            'id'            => null,
            ...
            // 'smartPhoneFieldGField' => empty($defaultCountryGField) ? false : true, // old validation, not used anymore
            'layoutGridColumnSpan' => $layoutGridColumnSpan,
    ...
    public static function Radio(
        ...
        $base = [
            ...
            'size'         => 'large',
            'layoutGridColumnSpan' => $layoutGridColumnSpan,
            'cssClass'     => trim('pwe-field__radio ' . ($cssClass ?? '')),
            'labelPlacement' => $labelPlacement,
    ...
    public static function Dropdown(
        ...
        return [
            ...
            'choices'        => $choices,
            'layoutGridColumnSpan' => $layoutGridColumnSpan,
            'cssClass'       => trim('pwe-field__dropdown ' . ($cssClass ?? '')),
            'conditionalLogic' => $conditionalLogic,
            'inputs'         => null,
        ];
    }
